...
[`@aws-sdk/client-mgn`](https://www.npmjs.com/package/@aws-sdk/client-mgn/v/3.744.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mgn@3.744.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MprN5iyKurop8pDeuY8u575rZY3IttfLk/etzomApSss+JOZVzeZgDzYF2MWmDPl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mgn": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mgn@3.744.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mgn@3.744.0/index.min.mjs": "sha384-MprN5iyKurop8pDeuY8u575rZY3IttfLk/etzomApSss+JOZVzeZgDzYF2MWmDPl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mgn/blob/refs/tags/3.744.0/LICENSE
```
